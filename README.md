...
Basic windows based GUI for Youtube-dl as a first project using Python.
Currently there is no support for playlists but that will be implemented later on.
